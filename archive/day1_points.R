...
ggplot() +
  ...
  theme(
    plot.title = element_text(size = rel(2.5), family = "roboto_black", face = "bold", color = "#333333"),
    ...
    plot.margin = margin(t = 20, r = 40, b = 30, l = 40)  # Adjust plot margins to give space for the legend
  ) +
  labs(
